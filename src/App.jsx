...
const DAYS = {
  ...
  C: {
    ...
    ex: [
      ...
      { id: "c12", n: "Press Pallof (oblicuos)", lbl: "stack polea", u: "lb", step: 5, rng: [10, 15], cues: ["Anti-rotación: resiste el giro, no gires", "Brazos extendidos al frente, core firme", "Cero flexión lumbar: ideal para tu columna"], prev: [[20,12],[20,12],[20,12]] },
  ...
  return (
    <div className="p-4 flex flex-col gap-4" style={{ maxWidth: 480, margin: "0 auto", paddingBottom: 96 }}>
      ...
      <div style={{ fontSize: 17, lineHeight: 1.45, color: C.txt, borderLeft: `4px solid ${C.acc}`, paddingLeft: 12, fontStyle: "italic" }}>
        {SEED_SPARK[selId] || "Elige y ve por ello."}
      </div>
      {doneSetsCount > 0 ? (
      ...
      {(() => {
        ...
        const o = SEED_ORIGEN.by[selId] || SEED_ORIGEN.by.pC;
        return (
